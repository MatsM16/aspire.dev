...
1. Fork the repository
    ...
    As mentioned in the [Local dev setup](#%EF%B8%8F-local-dev-setup) section, start by forking the `aspire.dev` repository to your own GitHub account
...
1. Make your changes, considering the [writing style guide](#%EF%B8%8F-writing-style-guide)
