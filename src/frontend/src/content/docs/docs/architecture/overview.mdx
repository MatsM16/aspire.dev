...
<ThemeImage dark={LocalAppTopology} light={LocalAppTopologyLight} 
...
<ThemeImage dark={PublishAppTopology} light={PublishAppTopologyLight} 
            alt="Published app topology" />

## Dev-time orchestration

In run mode, [the AppHost orchestrates](/docs/get-started/app-host/) all resources defined in your app model. But how does it achieve this?
...
<ThemeImage dark={AppHostDcpFlow} light={AppHostDcpFlowLight} 
...
<ThemeImage dark={DcpArch} light={DcpArchLight} 
