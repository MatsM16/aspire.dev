...
<LearnMore>
  For additional information on annotations, see [Resource API Patterns: Annotations](/docs/architecture/resource-api-patterns/#annotations).
</LearnMore>
...
<Aside type="note">
A full example demonstrating custom resource logging with the Talking Clock resource can be found in the [Full Examples](/docs/architecture/resource-examples/) section.
</Aside>
