...
The Azure Storage hosting integration models various storage resources including blobs, queues, and tables. To access these types and APIs, add the [📦 Aspire.Hosting.Azure.Storage](https://www.nuget.org/packages/Aspire.Hosting.Azure.Storage) NuGet package to your AppHost project.
...
For more information, see [Container resource lifetime](/docs/architecture/resource-model/#built-in-resources-and-lifecycle).
