...
<InstallPackage packageName="Aspire.Hosting.Keycloak" shortName="keycloak" prerelease={true} />
...
<Aside type="tip">
If you'd rather connect to an existing Keycloak instance, call `AddConnectionString` instead. For more information, see [Reference existing resources](/docs/get-started/resources/).
</Aside>
...
<InstallDotNetPackage packageName="Aspire.Keycloak.Authentication" prerelease={true} />
