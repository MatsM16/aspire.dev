...
<Aside type="tip">
If you'd rather connect to an existing Elasticsearch instance, call `AddConnectionString` instead. For more information, see [Reference existing resources](/docs/get-started/resources/).
</Aside>
