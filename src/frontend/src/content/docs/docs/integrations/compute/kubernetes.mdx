...
Use [external parameters](/docs/get-started/resources/) to configure environment-specific values that should be different between development and production environments.
