...
<Aside type="tip">
If you'd rather connect to an existing Kafka server, call `AddConnectionString` instead. For more information on how to use `WithReference`, see [Resource dependencies](/docs/get-started/resources/) and [Configuration injection](/docs/get-started/app-host/).
</Aside>
