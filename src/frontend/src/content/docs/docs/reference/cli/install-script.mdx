...
This article describes the syntax for the Aspire installation scripts, available in both Bash and PowerShell versions. To download and use these scripts, see [Install as a native executable](/docs/get-started/install-cli/#install-as-a-native-executable).
...
- [Install Aspire CLI](/docs/get-started/install-cli/)
