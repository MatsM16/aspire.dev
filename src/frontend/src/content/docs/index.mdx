...
banner:
  content: |
    <strong>🚀 Aspire 13.0 has shipped!</strong> — <a href="/whats-new/aspire-13/">See what's new in Aspire 13.0.</a>
hero:
  ...
  actions:
    - text: Get Aspire
      link: /docs/get-started/install-cli/
    - text: Explore Docs
...
<FluidGrid minColumnWidth="30rem" gap='2rem'>
  <SimpleCard title="Code-centric control" icon="laptop" link="#define-your-stack-in-code">
    Define your stack in code—type-safe and readable. Run locally, deploy anywhere without architectural changes.
  </SimpleCard>
  <SimpleCard title="Modular and extensible" icon="puzzle" link="#explore-integrations">
    Orchestrate front ends, APIs, containers, and databases with zero rewrites. Extend Aspire to fit your stack—deploy anywhere.
  </SimpleCard>
  <SimpleCard title="Observability from the start" icon="magnifier" link="#opentelemetry-developer-dashboard">
    Built-in OpenTelemetry delivers logs, traces, and health checks automatically—debug faster with zero setup.
  </SimpleCard>
  <SimpleCard title="Flexible deployments" icon="rocket" link="#local-first-production-ready">
...
Aspire is modular, composable, and extensible. Configure relationships, deployment options, and dev-time flags in one place. [Learn more about the `AppHost`](/docs/get-started/app-host/).
...
**Built for your stack**, Aspire orchestrates apps in C#, Java, Python, JavaScript, TypeScript, Go, and more—use the languages you prefer. [Explore how to model your apps](/docs/get-started/resources/).
...
**Built for local development**, Aspire mirrors production environments on your machine, eliminating "works on my machine" issues for smooth deployments. [Learn about pipelines and app topology](/docs/get-started/pipelines/).
...
Use Aspire's CLI to spin everything up locally or create deployment artifacts during your CI/CD. [Dive in, and build your first Aspire app](/docs/get-started/first-app/).

<CardGrid>
  <a href="/reference/cli/commands/aspire-run/" class="clickable-card" data-disable-copy>
  ...
  <a href="/reference/cli/commands/aspire-deploy/" class="clickable-card" data-disable-copy>
...
**Multi-cloud, limitless integrations** — Connect Aspire to Azure, AWS, or your own infrastructure. Tap into a vast ecosystem of integrations to power any stack, anywhere. [Explore the integration gallery](/docs/integrations/gallery/).
